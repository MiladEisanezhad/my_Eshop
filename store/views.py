...
from .cache import get_cached_products
        ...
        ctx.update(
            {
                ...
                "new_arrivals": get_cached_products(
                    "home:new_arrivals",
                ...
                "on_sale_products": get_cached_products(
                    "home:on_sale_products",
                ...
                "category_banners": Banner.objects.filter(is_active=True, position="category_banner").order_by("ordering")[:3],
